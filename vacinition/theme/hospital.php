...
.banner {
  background-image: url('images/doctor.jpg'); /* Replace with your image path */
...
.banner h1 {
  ...
  transition: text-shadow 0.5s ease-in-out; /* Add transition for text-shadow */
}
...
.banner::before {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(0, 0, 0, 0.5); /* Adjust opacity for your shade */
  opacity: 0; /* Initially hidden */
  transition: opacity 0.5s ease-in-out; /* Add transition for the overlay */
}
...
.vaccine img {
  width: 99%;
  height: 200px; /* Adjust this value as needed for the desired height */
  object-fit: cover;
  border-radius: 8px;
  margin-bottom: 10px;
...
.vaccine img:hover {
  transform: scale(1.1); /* Increase size on hover (adjust as desired) */
}
...
.grid-container {
  ...
  .info-heading , .vaccine-heading , .data{
    display: flex;
  align-items: center;
  justify-content: center;
  }

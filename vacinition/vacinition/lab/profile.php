...
session_start();
$new = $_SESSION['name'];
$query = "Select * from hospital where user_email = '$new' ";
...
<div class="section-title">
          <h2>Information Of Hospital</h2>
        </div>
   <div class="container" >
  <div class="row"> 
    <div class="col-lg-12" >
      <div class="card text-white mb-3" style="max-width: 36rem; box-shadow: 5px 5px 10px black;left:300px; ">
